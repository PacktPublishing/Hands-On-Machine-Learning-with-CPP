...
#Chapter 13
cd $START_DIR/Chapter13/python
. ./export.sh
cp model.pt $START_DIR/Chapter13/android_classify/app/src/main/assets

cd $START_DIR/Chapter13/android_classify
...
# Find resulting APK file in the Chapter13/android_classify/app/build/outputs/apk/release/ folder
